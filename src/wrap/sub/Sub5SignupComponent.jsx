...
export default function Sub5SignupComponent() {
    ...
    const onClickIdBtn=(e)=>{
        ...
        if(regExp2.test(value)===false || regExp3.test(value)===true || regExp4.test(value)===true || regExp5.test(value)===false){
            ...
            axios({
                url: 'https://kkoma1221.dothome.co.kr/kurly_project/kurly_id_duplicate_check.php',
                method: 'POST',
                data: formData
            })
            .then((res)=>{
    ...
    const onClickEmailBtn=(e)=>{
        ...
        if(value===''){
            ...
            axios({
                url: 'https://kkoma1221.dothome.co.kr/kurly_project/kurly_email_duplicate_check.php',
                method: 'POST',
                data: formData
            })
            .then((res)=>{
    ...
    const onClickIdCheckBtn=(e)=>{
        ...
        axios({
            url: 'https://kkoma1221.dothome.co.kr/kurly_project/kurly_id_check.php',
            method: 'POST',
            data: formData
        })
        .then((res)=>{
    ...
    const onsubmitForm=(e)=>{
        ...
        if(state.아이디===''){
            ...
            axios({
                url: 'https://kkoma1221.dothome.co.kr/kurly_project/kurly_insert.php',
                method: 'POST',
