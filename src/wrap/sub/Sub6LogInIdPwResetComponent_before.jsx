...
export default function Sub6LogInIdPwResetComponent() {
    ...
    const onSubmitPwReset=(e)=>{
        ...
        axios({
            url: 'https://kkoma1221.dothome.co.kr/kurly_project/kurly_pw_reset.php',
            method: 'POST',
            data: formData
        })
        .then((res)=>{
