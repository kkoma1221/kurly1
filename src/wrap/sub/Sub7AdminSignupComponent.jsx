...
export default function Sub7AdminSignupComponent() {
    ...
    const onClickIdBtn=(e)=>{
        ...
        if(regExp2.test(value)===false || regExp3.test(value)===true || regExp4.test(value)===true || regExp5.test(value)===false){
            ...
            axios({
                url: 'https://kkoma1221.dothome.co.kr/kurly_project/green_kurly_admin_id_duplicate_check.php',
                method: 'POST',
                data: formData
            })
            .then((res)=>{
    ...
    const onClickEmailBtn=(e)=>{
        ...
        if(value===''){
            ...
            axios({
                url: 'https://kkoma1221.dothome.co.kr/kurly_project/green_kurly_admin_email_duplicate_check.php',
                method: 'POST',
                data: formData
            })
            .then((res)=>{
    ...
    const onsubmitForm=(e)=>{
        ...
        if(state.아이디===''){
            ...
            axios({
                url: 'https://kkoma1221.dothome.co.kr/kurly_project/green_kurly_admin_signup.php',
                method: 'POST',
                data: formData
            })
            .then((res)=>{
