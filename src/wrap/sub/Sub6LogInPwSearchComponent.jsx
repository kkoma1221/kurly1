...
export default function Sub6LogInPwSearchComponent(){
    ...
    const onSubmitHpAuthen=(e)=>{
        ...
        axios({
            url: 'https://kkoma1221.dothome.co.kr/kurly_project/kurly_pw_search_id_hp_select.php',
            method: 'POST',
            data: formData
        })
        .then((res)=>{
    ...
    return (
        <div id='sub6PwSearch' className='id-pw-search'>
            <section id="section1">
